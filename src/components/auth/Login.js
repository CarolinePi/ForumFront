        ...
        <Card className="card-style">
          ...
          <FormGroup>
            ...
            { currentState.loginError && currentState.loginError.Required_username ? (
              <small className="color-red">{currentState.loginError.Required_username}</small>
              ) : (
                ""
            )}
            { currentState.loginError && currentState.loginError.Invalid_username ? (
              <small className="color-red">{ currentState.loginError.Invalid_username }</small>
              ) : (
                ""
            )}
            </FormGroup>
            ...
            <div className="mt-2" style={{display: "flex", justifyContent: "space-between"}}>
              <div>
                <small><Link to="/registration">Sign Up</Link></small>
              </div>
              <div>
